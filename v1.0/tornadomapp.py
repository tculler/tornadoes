...
APP_VERSION = "v1.0"
# Keep this in sync with each minor/major release for this script copy.
VERSION_TRACK = ["v1.0"]
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        default_locations = [token for token in ["__AREA__::United States::Michigan"] if token in location_options]
