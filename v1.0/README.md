...
The app opens at `http://localhost:8501`. Data is downloaded from NOAA or CNTD on first use and cached locally; subsequent loads are near-instant.
...
|---------|------|-------------|
| **Locations** | Multi-select | Single combined selector for U.S. states and Canadian provinces/territories. Options are grouped under country headers (default: Michigan). |
